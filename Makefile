...
test-utilities-osx:
	...
	xcrun -sdk macosx swiftc Source/TestUtilities.swift main.swift -o test_color_print
	./test_color_print
	rm main.swift test_color_print

test-unit-test-osx:
	cp tests/test_unit_test.swift main.swift
	xcrun -sdk macosx swiftc Source/TestUtilities.swift Source/Errors.swift Source/UnitTest.swift main.swift -o test_unit_test
	./test_unit_test
	rm main.swift test_unit_test

test-allclose-osx:
	cp tests/test_allclose.swift main.swift
	xcrun -sdk macosx swiftc Source/TestUtilities.swift Source/Errors.swift Source/UnitTest.swift main.swift -o test_allclose
	./test_allclose
